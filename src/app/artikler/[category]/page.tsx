...
export async function generateMetadata({
  ...
  if (!articlesData?.data) {
    return generatePageMetadata({
      title: `${category} Artikler | Advokattipset.no`,
  ...
  return generatePageMetadata({
    title: metaTitle || `${category} Artikler | Advokattipset.no`,
    description:
      metaDescription ||
      `Read expert Artikler om ${category} on Advokattipset.no.`,
    path: pathname,
    ...
    ogDescription:
      ogDescription ||
      metaDescription ||
      `Explore helpful ${category} artikler from Advokattipset.no.`,
